...
fn probe_crt_depth_for_goldreich_ring_gsw_bench(
    ...
    info!(
        "crt_depth={} active_levels={} error_sim_active_levels={} active_q_bits={} full_q_bits={} ring_gsw_q_bits={} non_free_depth_contributions={:?} num_inputs={} output_polys={} sim_max_eval_error_bits={} max_eval_error_bits={} eval_threshold_bits={} eval_ok={}",
        crt_depth,
        active_levels,
        ERROR_SIM_ACTIVE_LEVELS,
        active_q.bits(),
...
async fn test_gpu_lwe_nested_rns_goldreich_ring_gsw_bench() {
    ...
    let pubkey_bench_public_keys = sample_benchmark_pubkeys(
        ...
        cfg.d_secret,
        1,
        b"LWE_NESTED_RNS_GOLDREICH_RING_GSW_PUBKEY_BENCH",
    );
