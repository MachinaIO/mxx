...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftExpression := ⟨6379⟩) (rightExpression := ⟨14897⟩)
    (transferEvent := 2227)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨14898⟩) (rightExpression := ⟨15058⟩)
    (transferEvent := 2231)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨15059⟩) (rightExpression := ⟨15219⟩)
    (transferEvent := 2235)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨15220⟩) (rightExpression := ⟨15527⟩)
    (transferEvent := 2239)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨15528⟩) (rightExpression := ⟨17831⟩)
    (transferEvent := 2243)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨17832⟩) (rightExpression := ⟨17447⟩)
    (transferEvent := 2247)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨17833⟩) (rightExpression := ⟨17230⟩)
    (transferEvent := 2251)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨17834⟩) (rightExpression := ⟨17174⟩)
    (transferEvent := 2255)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨17835⟩) (rightExpression := ⟨18050⟩)
    (transferEvent := 2259)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨18051⟩) (rightExpression := ⟨17671⟩)
    (transferEvent := 2263)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨18052⟩) (rightExpression := ⟨17615⟩)
    (transferEvent := 2267)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨18053⟩) (rightExpression := ⟨18864⟩)
    (transferEvent := 2271)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨18865⟩) (rightExpression := ⟨17559⟩)
    (transferEvent := 2275)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨18866⟩) (rightExpression := ⟨17958⟩)
    (transferEvent := 2279)
  · rfl
  · rfl
  · rfl
