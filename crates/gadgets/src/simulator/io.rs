...
pub struct SecureRingDimSearchResult {
...
pub struct SecureRingDimLatticeCache {
...
impl SecureRingDimLatticeCache {
    ...
    pub fn record(&mut self, crt_depth: usize, result: SecureRingDimSearchResult) {
        self.entries.push((crt_depth, result));
    }
}

pub fn assert_lattice_estimator_available(protocol_name: &str) {
...
pub fn select_min_secure_ring_dim<P, BuildParams>(
    protocol_name: &str,
    crt_depth: usize,
...
pub fn select_min_secure_ring_dim_gaussian_only<P, BuildParams>(
    protocol_name: &str,
    crt_depth: usize,
    min_log_ring_dim: usize,
    max_log_ring_dim: usize,
...
pub struct CpuRingGswContextConfig {
...
pub fn cpu_params_from_poly_params<P: PolyParams>(
    params: &P,
    protocol_name: &str,
) -> DCRTPolyParams {
...
pub fn simulator_context(params: &DCRTPolyParams, secret_size: usize) -> Arc<SimulatorContext> {
...
pub fn final_mask_coeff_bits_for_error_margin(
    params: &DCRTPolyParams,
...
#[cfg(test)]
pub fn noise_refresh_pre_round_margin(
    params: &DCRTPolyParams,
    v_bits: usize,
) -> Option<BigDecimal> {
...
pub fn noise_refresh_v_bits_for_error_margin(
    params: &DCRTPolyParams,
...
pub fn noise_refresh_security_margin_holds(
    params: &DCRTPolyParams,
...
pub fn noise_refresh_worst_pre_rounding_error_bound(
    refresh: &NoiseRefreshErrorSimulation,
) -> BigDecimal {
    refresh
        .pre_round_outputs
...
pub fn minimum_seed_refresh_prf_seed_bits(
    branch_count: usize,
    protocol_name: &str,
...
pub fn max_final_mask_coeff_bits_for_seed<F>(
    params: &DCRTPolyParams,
    output_size: usize,
...
pub fn eval_first_error_output<PE>(
...
pub fn simulate_selected_branch_rebase_error_norm(
    one: ErrorNorm,
...
pub fn branch_rebase_decoder_error(error: ErrorNorm, target_col_size: usize) -> ErrorNorm {
...
pub fn ring_gsw_and_randomizer_norm(
    lhs: &PolyMatrixNorm,
...
pub fn ring_gsw_xor_randomizer_norm(
    lhs: &PolyMatrixNorm,
    rhs: &PolyMatrixNorm,
    decomposed: &PolyMatrixNorm,
) -> PolyMatrixNorm {
...
pub fn representative_goldreich_prg_ciphertext_randomizer_norm(
...
pub fn ciphertext_decryption_error_from_randomizer(
...
pub fn prf_refresh_ciphertext_state(
    seed_ciphertext_randomizer_norm: &PolyMatrixNorm,
    decomposed_randomizer_norm: &PolyMatrixNorm,
    output_ctx: Arc<SimulatorContext>,
    full_active_levels: usize,
...
pub fn initial_seed_wire_error(
    one: &ErrorNorm,
    p_moduli: &[u64],
    protocol_name: &str,
) -> ErrorNorm {
...
pub fn build_cpu_ring_gsw_context(
    params: &DCRTPolyParams,
...
pub fn seed_ciphertext_randomizer_norms(
    params: &DCRTPolyParams,
    config: CpuRingGswContextConfig,
) -> (PolyMatrixNorm, PolyMatrixNorm) {
...
pub fn representative_goldreich_prg_one_output_circuit(
    params: &DCRTPolyParams,
    active_levels: usize,
    seed_bits: usize,
    config: CpuRingGswContextConfig,
...
pub fn simulate_final_mask_base_error<PE, ST>(
    params: &DCRTPolyParams,
    active_levels: usize,
    config: CpuRingGswContextConfig,
...
pub fn simulate_representative_function_output<PE, ST>(
    params: &DCRTPolyParams,
    active_levels: usize,
    config: CpuRingGswContextConfig,
...
pub fn simulate_representative_prg_output<PE, ST>(
    params: &DCRTPolyParams,
    active_levels: usize,
...
#[allow(clippy::too_many_arguments)]
pub fn simulate_noise_refresh_from_material_state<PE, ST>(
...
pub fn prf_refresh_material_inputs(
    one: ErrorNorm,
...
pub fn refreshed_seed_from_noise_refresh(
    refresh: &NoiseRefreshErrorSimulation,
    protocol_name: &str,
) -> ErrorNorm {
...
pub fn add_ciphertext_decryption_residual_to_noise_refresh_pre_rounds(
...
pub struct PrfRefreshRoundCore {
    pub refresh: NoiseRefreshErrorSimulation,
    pub refreshed_seed: ErrorNorm,
}

#[allow(clippy::too_many_arguments)]
pub fn simulate_prf_refresh_round_fixed_core<PE, ST>(
    params: &DCRTPolyParams,
    ring_gsw_context: Arc<NestedRnsRingGswContext<DCRTPoly>>,
    seed_bits: usize,
    noise_refresh_v_bits: usize,
...
pub fn expand_logical_errors(logical_errors: &[ErrorNorm], wire_count: usize) -> Vec<ErrorNorm> {
...
pub fn scale_error_norm(input: ErrorNorm, scale: &BigDecimal) -> ErrorNorm {
...
pub fn assert_same_matrix_shape(lhs: &PolyMatrixNorm, rhs: &PolyMatrixNorm, message: &str) {
...
pub fn extrapolate_error_norm_matrix_to_active_levels(
    mut input: ErrorNorm,
    active_levels: usize,
) -> ErrorNorm {
...
pub fn ring_gsw_wire_count(flat_input_count: usize, logical_bit_count: usize) -> usize {
