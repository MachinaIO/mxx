...
namespace Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Semantic.SemanticShard018

open Mxx.Certificate.OperationalNoise
open TallSecurity0ABI
open TallSemantics

def shardIndex : Nat := 18
def shardStartEvent : Nat := 4608
def shardEndEvent : Nat := 4864
...
def selectedSumRuleEvent : Nat := 4618
def selectedLeftResultEvent : Nat := 4615
def selectedRightResultEvent : Nat := 4612
def selectedResultEvent : Nat := 4620
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4616 .coefficient) (.predecessor 1 4617 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation0

namespace Operation1
def selectedEvent : Nat := 4643
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4641
def selectedLeftResultEvent : Nat := 4638
def selectedRightResultEvent : Nat := 4635
def selectedResultEvent : Nat := 4643
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4639 .coefficient) (.predecessor 1 4640 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation1

namespace Operation2
def selectedEvent : Nat := 4666
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4664
def selectedLeftResultEvent : Nat := 4661
def selectedRightResultEvent : Nat := 4658
def selectedResultEvent : Nat := 4666
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4662 .coefficient) (.predecessor 1 4663 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation2

namespace Operation3
def selectedEvent : Nat := 4689
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4687
def selectedLeftResultEvent : Nat := 4684
def selectedRightResultEvent : Nat := 4681
def selectedResultEvent : Nat := 4689
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4685 .coefficient) (.predecessor 1 4686 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation3

namespace Operation4
def selectedEvent : Nat := 4712
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4710
def selectedLeftResultEvent : Nat := 4707
def selectedRightResultEvent : Nat := 4704
def selectedResultEvent : Nat := 4712
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4708 .coefficient) (.predecessor 1 4709 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation4

namespace Operation5
def selectedEvent : Nat := 4735
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4733
def selectedLeftResultEvent : Nat := 4730
def selectedRightResultEvent : Nat := 4727
def selectedResultEvent : Nat := 4735
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4731 .coefficient) (.predecessor 1 4732 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation5

namespace Operation6
def selectedEvent : Nat := 4758
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4756
def selectedLeftResultEvent : Nat := 4753
def selectedRightResultEvent : Nat := 4750
def selectedResultEvent : Nat := 4758
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4754 .coefficient) (.predecessor 1 4755 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation6

namespace Operation7
def selectedEvent : Nat := 4781
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4779
def selectedLeftResultEvent : Nat := 4776
def selectedRightResultEvent : Nat := 4773
def selectedResultEvent : Nat := 4781
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4777 .coefficient) (.predecessor 1 4778 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation7

namespace Operation8
def selectedEvent : Nat := 4804
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4802
def selectedLeftResultEvent : Nat := 4799
def selectedRightResultEvent : Nat := 4796
def selectedResultEvent : Nat := 4804
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4800 .coefficient) (.predecessor 1 4801 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation8

namespace Operation9
def selectedEvent : Nat := 4827
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4825
def selectedLeftResultEvent : Nat := 4822
def selectedRightResultEvent : Nat := 4819
def selectedResultEvent : Nat := 4827
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4823 .coefficient) (.predecessor 1 4824 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl

end Operation9

namespace Operation10
def selectedEvent : Nat := 4850
...
def outputSummary : Bound := .exactZero
def selectedRawWork : Nat := 1
def selectedSumRuleEvent : Nat := 4848
def selectedLeftResultEvent : Nat := 4845
def selectedRightResultEvent : Nat := 4842
def selectedResultEvent : Nat := 4850
def leftScalar : Bool := false
def rightScalar : Bool := false
...
theorem selectedRuleAt : (history.lookup selectedSumRuleEvent).map AnnotatedEvent.event = some (.boundTransfer selectedOwner (.product (.predecessor 0 4846 .coefficient) (.predecessor 1 4847 .coefficient) ⟨true, true, none, some 1, some 1⟩)) := by
  rfl
...
end Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Semantic.SemanticShard018
