...
//         assert_eq!(
//             result[0].plaintext.as_ref().unwrap(),
//             expected.plaintext.as_ref().unwrap()
//         );
//     }
...
//         info!(
//             "b_l_plus_one ({},{})",
//             b_l_plus_one.row_size(),
//             b_l_plus_one.col_size()
//         );
//         /* BGG+ encoding setup */
//         let secrets = uni
//             .sample_uniform(&params, 1, d, DistType::BitDist)
//             .get_row(0);
...
//         let expected_pubkey_output = &circuit.eval(
//             &params,
//             &pubkeys[0],
//             &[pubkeys[1].clone()],
//             Some(pubkey_plt_evaluator),
//         )[0];
