...
theorem mergeClaim (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorProductMergeClaim
    ...
    (leftResult := 5163) (rightResult := 653)
...
theorem mergeClaim (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorProductMergeClaim
    ...
    (leftResult := 5171) (rightResult := 663)
...
theorem mergeClaim (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorProductMergeClaim
    ...
    (leftResult := 5179) (rightResult := 673)
...
theorem mergeClaim (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorProductMergeClaim
    ...
    (leftResult := 5187) (rightResult := 683)
...
theorem mergeClaim (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorProductMergeClaim
    ...
    (leftResult := 5195) (rightResult := 693)
...
namespace SemanticResult5203
def owner : Owner := ⟨.program ⟨257⟩, ⟨18880⟩⟩
def rawTerms : List Term := Proof.Events020.exact5203RawTerms
def summary : Bound := .exactZero
def resultEvent : Nat := 5203
def producerEvent : Nat := 5202
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Int :=
  Cert.ResidualResult5203.actual selector witness
theorem terminalAt (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
    (selectorUpper : selector < selectorMaximum) :
    TerminalExactAt document history (some selector) producerEvent resultEvent owner rawTerms := by
  refine ⟨by decide, ?_, ?_⟩
...
theorem mergeClaim (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
    ...
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    ValueClaim.Interprets 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817 witness.env (actual selector witness)
      (.exact LeftOperatorMerge5207.working .exactZero) := by
  apply operatorProductMergeClaim
    (document := document) (history := history) (env := witness.env)
    (frameStart := LeftOperatorMerge5207.frameStart)
    (transferEvent := 5206) (owner := owner)
    (leftResult := 5203) (rightResult := 703)
    (working := LeftOperatorMerge5207.working)
    (reconstruction := LeftOperatorMerge5207.reconstruction)
    (leftReference := .predecessor 0 5204 .coefficient) (rightReference := .predecessor 1 5205 .coefficient)
    (facts := ⟨true, true, none, some 1, some 1⟩)
    (leftScalar := false) (rightScalar := false)
  · rfl
  · rfl
  · exact SemanticResult5203.claimSound selector selectorLower selectorUpper witness
  · exact SemanticResult703.claimSound selector selectorLower selectorUpper witness
  · exact LeftOperatorMerge5207.operationAgreement
  · decide
...
namespace SemanticResult5211
def owner : Owner := ⟨.program ⟨257⟩, ⟨16046⟩⟩
def rawTerms : List Term := Proof.Events020.exact5211RawTerms
def summary : Bound := .exactZero
def resultEvent : Nat := 5211
def producerEvent : Nat := 5210
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Int :=
  Cert.ResidualResult5211.actual selector witness
theorem terminalAt (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
    (selectorUpper : selector < selectorMaximum) :
    TerminalExactAt document history (some selector) producerEvent resultEvent owner rawTerms := by
  refine ⟨by decide, ?_, ?_⟩
...
theorem mergeClaim (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
    ...
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    ValueClaim.Interprets 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817 witness.env (actual selector witness)
      (.exact LeftOperatorMerge5215.working .exactZero) := by
  apply operatorProductMergeClaim
    (document := document) (history := history) (env := witness.env)
    (frameStart := LeftOperatorMerge5215.frameStart)
    (transferEvent := 5214) (owner := owner)
    (leftResult := 5211) (rightResult := 713)
    (working := LeftOperatorMerge5215.working)
    (reconstruction := LeftOperatorMerge5215.reconstruction)
    (leftReference := .predecessor 0 5212 .coefficient) (rightReference := .predecessor 1 5213 .coefficient)
    (facts := ⟨true, true, none, some 1, some 1⟩)
    (leftScalar := false) (rightScalar := false)
  · rfl
  · rfl
  · exact SemanticResult5211.claimSound selector selectorLower selectorUpper witness
  · exact SemanticResult713.claimSound selector selectorLower selectorUpper witness
  · exact LeftOperatorMerge5215.operationAgreement
  · decide
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftExpression := ⟨6728⟩) (rightExpression := ⟨16047⟩)
    (transferEvent := 5219)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨16048⟩) (rightExpression := ⟨18881⟩)
    (transferEvent := 5223)
  · rfl
  · rfl
  · rfl
