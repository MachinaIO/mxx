...
use crate::{
    bench_estimator::{
        BenchEstimator, CircuitBenchEstimate, CircuitBenchSummary, NativePolyMatrixBenchEstimator,
        PublicKeyAuxBenchEstimator, benchmark_gate_operation,
        estimate_public_key_circuit_bench_with_aux, scale_independent_summary,
    },
...
where
    PKBE: Sync,
    EncBE: Sync,
    NBE: NativePolyMatrixBenchEstimator + Sync,
{
...
mod tests {
    ...
    impl NativePolyMatrixBenchEstimator for DummyNativeBenchEstimator {
