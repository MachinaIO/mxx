...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftExpression := ⟨67223⟩) (rightExpression := ⟨37757⟩)
    (transferEvent := 1531)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨67224⟩) (rightExpression := ⟨40440⟩)
    (transferEvent := 1535)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨67225⟩) (rightExpression := ⟨43120⟩)
    (transferEvent := 1539)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨67226⟩) (rightExpression := ⟨45797⟩)
    (transferEvent := 1543)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorAddNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨67227⟩) (rightExpression := ⟨48477⟩)
    (transferEvent := 1547)
  · rfl
  · rfl
  · rfl
...
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  apply operatorSubNoMergeExactZeroClaimAt
    ...
    (leftInputPosition := 0) (rightInputPosition := 1)
    (leftExpression := ⟨67228⟩) (rightExpression := ⟨67648⟩)
    (transferEvent := 1551)
  · rfl
  · rfl
  · rfl
...
theorem terminalAt (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
  ...
  · refine ⟨.authority (.factStore), 0, .finite 41789940958035988627979300485852703477395331860102123197512636441004599112254790558222903630232221800370484068387521121242021617935078661940894842930504122706572345476, .authorityFactStore, ?_, ?_⟩
    · rfl
    · rfl
theorem claimSound (selector : Nat) (selectorLower : selectorMinimum ≤ selector)
    (selectorUpper : selector < selectorMaximum)
