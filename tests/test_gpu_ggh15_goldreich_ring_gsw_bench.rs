...
fn find_crt_depth_for_goldreich_ring_gsw_bench(
    ...
    let min_crt_depth = env_or_parse_usize("GGH15_GOLDREICH_RING_GSW_BENCH_MIN_CRT_DEPTH", 1usize);
    assert!(
        min_crt_depth <= cfg.max_crt_depth,
        "GGH15_GOLDREICH_RING_GSW_BENCH_MIN_CRT_DEPTH must be <= GGH15_GOLDREICH_RING_GSW_BENCH_MAX_CRT_DEPTH"
    );
