    ...
    S: SessionStore,
{
    ...
    fn execute_preimage_batch(
        ...
        for instance in 0..values.len() {
            ...
            // Evaluate this before dispatching on trapdoor provenance.  The gadget branch ignores
            // the cutoff after validation, but must reject the same malformed expression as the
