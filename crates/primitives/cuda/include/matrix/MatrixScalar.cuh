...
int gpu_matrix_prepare_scalar_buffer(const GpuMatrix *anchor, size_t count, size_t words,
    uint64_t *host, const GpuPreparedPlanDescriptor *plan, GpuPreparedScalarBuffer **out);
...
int gpu_matrix_prepare_scalar_matrix_select(GpuMatrix *output, GpuPreparedScalarRef selector,
    ...
    const GpuPreparedPlanDescriptor *plan, GpuPreparedScalarMatrixSelect **out);
...
int gpu_matrix_prepare_threshold(const GpuMatrix *source, size_t count,
    ...
    GpuPreparedScalarBuffer *output, const GpuPreparedPlanDescriptor *plan, GpuPreparedThreshold **out);
...
int gpu_matrix_prepare_scalar_pack(GpuMatrix *output, const GpuPreparedScalarRef *values,
    size_t count, size_t coefficient_bits, const GpuPreparedPlanDescriptor *plan, GpuPreparedScalarPack **out);
