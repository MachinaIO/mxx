...
digit_count={digit_count}"
    ...
    println!("workspace_word_bytes={}", allocation.workspace_word_bytes);
    println!("ntt_preparation_launches={}", allocation.ntt_preparation_launches);
    println!("u32_workspace_limb_count={}", allocation.u32_workspace_limb_count);
    println!("u64_workspace_limb_count={}", allocation.u64_workspace_limb_count);
