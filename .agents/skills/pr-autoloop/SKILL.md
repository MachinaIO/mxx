...
4. Never inspect `docs/prs/active/*.md` or ask resume/new PR questions until task input has been resolved.
...
7. If `--pr-url` is not provided, inspect `docs/prs/active/*.md` regardless of current local branch:
