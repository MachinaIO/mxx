...
RUN_ID="qgga47ub38w1py_8rtxpro6000_b78ee6c_diamond_we_full_w8b1_chunk1_selected_crt22_log15_iter5_20260620_2350JST"
...
write_status() {
  ...
  write_vram_status
  {
    ...
    echo "expected_commit=b78ee6ce43440600d5ddb35e0d5d55d518f96a29"
...
echo "expected_commit=b78ee6ce43440600d5ddb35e0d5d55d518f96a29" >> "${STATUS}"
