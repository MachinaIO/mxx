...
generic `mxx-noise-simulator` derives operational-noise bounds from the actual lowered graph;
Power-LUT does not maintain a replacement-bound replay or a parallel Lean claim.
