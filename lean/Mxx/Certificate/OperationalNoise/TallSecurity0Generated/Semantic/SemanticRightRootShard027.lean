import Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Semantic.SemanticRightRootShard026
...
namespace SemanticRightRootResult5264

def leftRaw : List Term := SemanticRightRootResult5260.rawTerms
def rightRaw : List Term := SemanticRightRootResult5080.rawTerms
...
def actual (selector : Nat)
  ...
  SemanticRightRootResult5260.actual selector witness +
    SemanticRightRootResult5080.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18798 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18798)
    (leftPredecessorAt : (history.lookup 5261).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18797⟩ 5260))
    (rightPredecessorAt : (history.lookup 5262).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨17485⟩ 5080))
    (ruleAt : (history.lookup 5263).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5261 .coefficient, .predecessor 1 5262 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5260.resultEvent
      SemanticRightRootResult5260.owner
      (SemanticRightRootResult5260.actual selector witness)
      SemanticRightRootResult5260.rawTerms
      SemanticRightRootResult5260.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5080.resultEvent
      SemanticRightRootResult5080.owner
      (SemanticRightRootResult5080.actual selector witness)
      SemanticRightRootResult5080.rawTerms
      SemanticRightRootResult5080.summary)
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5260.actual selector witness)
    (SemanticRightRootResult5080.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5260.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult5080.summary] using rightClaim.claim)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
  ...
  · exact SemanticRightRootResult5260.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult5080.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5264

namespace SemanticRightRootResult5268

def leftRaw : List Term := SemanticRightRootResult5264.rawTerms
def rightRaw : List Term := SemanticRightRootResult5072.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5264.actual selector witness +
    SemanticRightRootResult5072.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18799 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18799)
    (leftPredecessorAt : (history.lookup 5265).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18798⟩ 5264))
    (rightPredecessorAt : (history.lookup 5266).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨16918⟩ 5072))
    (ruleAt : (history.lookup 5267).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5265 .coefficient, .predecessor 1 5266 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5264.resultEvent
      SemanticRightRootResult5264.owner
      (SemanticRightRootResult5264.actual selector witness)
      SemanticRightRootResult5264.rawTerms
      SemanticRightRootResult5264.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5072.resultEvent
      SemanticRightRootResult5072.owner
      (SemanticRightRootResult5072.actual selector witness)
      SemanticRightRootResult5072.rawTerms
      SemanticRightRootResult5072.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5264.actual selector witness)
    (SemanticRightRootResult5072.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5264.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult5072.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5264.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult5072.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5268

namespace SemanticRightRootResult5272

def leftRaw : List Term := SemanticRightRootResult5268.rawTerms
def rightRaw : List Term := SemanticRightRootResult5064.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5268.actual selector witness +
    SemanticRightRootResult5064.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18800 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18800)
    (leftPredecessorAt : (history.lookup 5269).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18799⟩ 5268))
    (rightPredecessorAt : (history.lookup 5270).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18115⟩ 5064))
    (ruleAt : (history.lookup 5271).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5269 .coefficient, .predecessor 1 5270 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5268.resultEvent
      SemanticRightRootResult5268.owner
      (SemanticRightRootResult5268.actual selector witness)
      SemanticRightRootResult5268.rawTerms
      SemanticRightRootResult5268.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5064.resultEvent
      SemanticRightRootResult5064.owner
      (SemanticRightRootResult5064.actual selector witness)
      SemanticRightRootResult5064.rawTerms
      SemanticRightRootResult5064.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5268.actual selector witness)
    (SemanticRightRootResult5064.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5268.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult5064.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5268.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult5064.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5272

namespace SemanticRightRootResult5276

def leftRaw : List Term := SemanticRightRootResult5272.rawTerms
def rightRaw : List Term := SemanticRightRootResult5056.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5272.actual selector witness -
    SemanticRightRootResult5056.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18802 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18802)
    (leftPredecessorAt : (history.lookup 5273).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18800⟩ 5272))
    (rightPredecessorAt : (history.lookup 5274).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18486⟩ 5056))
    (ruleAt : (history.lookup 5275).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5273 .coefficient, .predecessor 1 5274 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5272.resultEvent
      SemanticRightRootResult5272.owner
      (SemanticRightRootResult5272.actual selector witness)
      SemanticRightRootResult5272.rawTerms
      SemanticRightRootResult5272.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5056.resultEvent
      SemanticRightRootResult5056.owner
      (SemanticRightRootResult5056.actual selector witness)
      SemanticRightRootResult5056.rawTerms
      SemanticRightRootResult5056.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_sub_exactZero_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5272.actual selector witness)
    (SemanticRightRootResult5056.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5272.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult5056.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5272.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult5056.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5276

namespace SemanticRightRootResult5299

def leftRaw : List Term := SemanticRightRootResult5276.rawTerms
def rightRaw : List Term := SemanticRightRootResult4563.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5276.actual selector witness *
    SemanticRightRootResult4563.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18803 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18803)
    (leftPredecessorAt : (history.lookup 5277).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18802⟩ 5276))
    (rightPredecessorAt : (history.lookup 5278).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨6384⟩ 4563))
    (ruleAt : (history.lookup 5279).map AnnotatedEvent.event =
      some (.boundTransfer owner (.product (.predecessor 0 5277 .coefficient) (.predecessor 1 5278 .coefficient) ⟨false, true, none, none, some 1⟩)))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5276.resultEvent
      SemanticRightRootResult5276.owner
      (SemanticRightRootResult5276.actual selector witness)
      SemanticRightRootResult5276.rawTerms
      SemanticRightRootResult5276.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult4563.resultEvent
      SemanticRightRootResult4563.owner
      (SemanticRightRootResult4563.actual selector witness)
      SemanticRightRootResult4563.rawTerms
      SemanticRightRootResult4563.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_product_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5276.actual selector witness)
    (SemanticRightRootResult4563.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5276.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult4563.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5276.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult4563.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5299

namespace SemanticRightRootResult5303

def leftRaw : List Term := SemanticRightRootResult728.rawTerms
def rightRaw : List Term := SemanticRightRootResult5299.rawTerms
def outputRaw : List Term := [{ coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6383⟩⟩, ⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨18016⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6387⟩⟩, ⟨.program ⟨214⟩, ⟨17155⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6391⟩⟩, ⟨.program ⟨214⟩, ⟨17211⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6398⟩⟩, ⟨.program ⟨214⟩, ⟨17428⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6407⟩⟩, ⟨.program ⟨214⟩, ⟨17792⟩⟩], orderedFactors := [] } }, { coefficient := (-1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6410⟩⟩, ⟨.program ⟨214⟩, ⟨18485⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6427⟩⟩, ⟨.program ⟨214⟩, ⟨15503⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6435⟩⟩, ⟨.program ⟨214⟩, ⟨18114⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6437⟩⟩, ⟨.program ⟨214⟩, ⟨16917⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6449⟩⟩, ⟨.program ⟨214⟩, ⟨17484⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6452⟩⟩, ⟨.program ⟨214⟩, ⟨15195⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6459⟩⟩, ⟨.program ⟨214⟩, ⟨17708⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6467⟩⟩, ⟨.program ⟨214⟩, ⟨17939⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6473⟩⟩, ⟨.program ⟨214⟩, ⟨17540⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6475⟩⟩, ⟨.program ⟨214⟩, ⟨15034⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6490⟩⟩, ⟨.program ⟨214⟩, ⟨18792⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6494⟩⟩, ⟨.program ⟨214⟩, ⟨17596⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6495⟩⟩, ⟨.program ⟨214⟩, ⟨14873⟩⟩], orderedFactors := [] } }, { coefficient := (1), monomial := { centralFactors := [⟨.program ⟨214⟩, ⟨6384⟩⟩, ⟨.program ⟨214⟩, ⟨6502⟩⟩, ⟨.program ⟨214⟩, ⟨17652⟩⟩], orderedFactors := [] } }]
def left : Polynomial Owner := leftRaw.map Term.toExact
def right : Polynomial Owner := rightRaw.map Term.toExact
def output : Polynomial Owner := outputRaw.map Term.toExact
...
def actual (selector : Nat)
  ...
  SemanticRightRootResult728.actual selector witness +
    SemanticRightRootResult5299.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18804 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18804)
    (leftPredecessorAt : (history.lookup 5300).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨6379⟩ 728))
    (rightPredecessorAt : (history.lookup 5301).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18803⟩ 5299))
    (ruleAt : (history.lookup 5302).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5300 .coefficient, .predecessor 1 5301 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
    ...
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5299.resultEvent
      SemanticRightRootResult5299.owner
      (SemanticRightRootResult5299.actual selector witness)
      SemanticRightRootResult5299.rawTerms
      SemanticRightRootResult5299.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult728.actual selector witness)
    (SemanticRightRootResult5299.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult728.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult5299.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
  ...
  · exact SemanticRightRootResult728.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult5299.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5303

namespace SemanticRightRootResult5307

def leftRaw : List Term := SemanticRightRootResult5303.rawTerms
def rightRaw : List Term := SemanticRightRootResult4561.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5303.actual selector witness +
    SemanticRightRootResult4561.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18844 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18844)
    (leftPredecessorAt : (history.lookup 5304).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18804⟩ 5303))
    (rightPredecessorAt : (history.lookup 5305).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18843⟩ 4561))
    (ruleAt : (history.lookup 5306).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5304 .coefficient, .predecessor 1 5305 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5303.resultEvent
      SemanticRightRootResult5303.owner
      (SemanticRightRootResult5303.actual selector witness)
      SemanticRightRootResult5303.rawTerms
      SemanticRightRootResult5303.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult4561.resultEvent
      SemanticRightRootResult4561.owner
      (SemanticRightRootResult4561.actual selector witness)
      SemanticRightRootResult4561.rawTerms
      SemanticRightRootResult4561.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5303.actual selector witness)
    (SemanticRightRootResult4561.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5303.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult4561.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5303.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult4561.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5307

namespace SemanticRightRootResult5311

def leftRaw : List Term := SemanticRightRootResult5307.rawTerms
def rightRaw : List Term := SemanticRightRootResult3819.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5307.actual selector witness +
    SemanticRightRootResult3819.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18845 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18845)
    (leftPredecessorAt : (history.lookup 5308).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18844⟩ 5307))
    (rightPredecessorAt : (history.lookup 5309).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18829⟩ 3819))
    (ruleAt : (history.lookup 5310).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5308 .coefficient, .predecessor 1 5309 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5307.resultEvent
      SemanticRightRootResult5307.owner
      (SemanticRightRootResult5307.actual selector witness)
      SemanticRightRootResult5307.rawTerms
      SemanticRightRootResult5307.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult3819.resultEvent
      SemanticRightRootResult3819.owner
      (SemanticRightRootResult3819.actual selector witness)
      SemanticRightRootResult3819.rawTerms
      SemanticRightRootResult3819.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5307.actual selector witness)
    (SemanticRightRootResult3819.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5307.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult3819.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5307.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult3819.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5311

namespace SemanticRightRootResult5315

def leftRaw : List Term := SemanticRightRootResult5311.rawTerms
def rightRaw : List Term := SemanticRightRootResult3071.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5311.actual selector witness +
    SemanticRightRootResult3071.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18860 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18860)
    (leftPredecessorAt : (history.lookup 5312).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18845⟩ 5311))
    (rightPredecessorAt : (history.lookup 5313).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18859⟩ 3071))
    (ruleAt : (history.lookup 5314).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5312 .coefficient, .predecessor 1 5313 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5311.resultEvent
      SemanticRightRootResult5311.owner
      (SemanticRightRootResult5311.actual selector witness)
      SemanticRightRootResult5311.rawTerms
      SemanticRightRootResult5311.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult3071.resultEvent
      SemanticRightRootResult3071.owner
      (SemanticRightRootResult3071.actual selector witness)
      SemanticRightRootResult3071.rawTerms
      SemanticRightRootResult3071.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5311.actual selector witness)
    (SemanticRightRootResult3071.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5311.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult3071.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5311.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult3071.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5315

namespace SemanticRightRootResult5319

def leftRaw : List Term := SemanticRightRootResult5315.rawTerms
def rightRaw : List Term := SemanticRightRootResult2323.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5315.actual selector witness +
    SemanticRightRootResult2323.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18875 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18875)
    (leftPredecessorAt : (history.lookup 5316).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18860⟩ 5315))
    (rightPredecessorAt : (history.lookup 5317).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18874⟩ 2323))
    (ruleAt : (history.lookup 5318).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5316 .coefficient, .predecessor 1 5317 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5315.resultEvent
      SemanticRightRootResult5315.owner
      (SemanticRightRootResult5315.actual selector witness)
      SemanticRightRootResult5315.rawTerms
      SemanticRightRootResult5315.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult2323.resultEvent
      SemanticRightRootResult2323.owner
      (SemanticRightRootResult2323.actual selector witness)
      SemanticRightRootResult2323.rawTerms
      SemanticRightRootResult2323.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5315.actual selector witness)
    (SemanticRightRootResult2323.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5315.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult2323.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5315.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult2323.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5319

namespace SemanticRightRootResult5323

def leftRaw : List Term := SemanticRightRootResult5319.rawTerms
def rightRaw : List Term := SemanticRightRootResult1575.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5319.actual selector witness +
    SemanticRightRootResult1575.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18890 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18890)
    (leftPredecessorAt : (history.lookup 5320).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18875⟩ 5319))
    (rightPredecessorAt : (history.lookup 5321).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18889⟩ 1575))
    (ruleAt : (history.lookup 5322).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5320 .coefficient, .predecessor 1 5321 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5319.resultEvent
      SemanticRightRootResult5319.owner
      (SemanticRightRootResult5319.actual selector witness)
      SemanticRightRootResult5319.rawTerms
      SemanticRightRootResult5319.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult1575.resultEvent
      SemanticRightRootResult1575.owner
      (SemanticRightRootResult1575.actual selector witness)
      SemanticRightRootResult1575.rawTerms
      SemanticRightRootResult1575.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5319.actual selector witness)
    (SemanticRightRootResult1575.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5319.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult1575.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5319.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult1575.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5323

namespace SemanticRightRootResult5327

def leftRaw : List Term := SemanticRightRootResult5323.rawTerms
def rightRaw : List Term := SemanticRightRootResult827.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5323.actual selector witness +
    SemanticRightRootResult827.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18905 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18905)
    (leftPredecessorAt : (history.lookup 5324).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18890⟩ 5323))
    (rightPredecessorAt : (history.lookup 5325).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨18904⟩ 827))
    (ruleAt : (history.lookup 5326).map AnnotatedEvent.event =
      some (.boundTransfer owner (.sum [.predecessor 0 5324 .coefficient, .predecessor 1 5325 .coefficient])))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5323.resultEvent
      SemanticRightRootResult5323.owner
      (SemanticRightRootResult5323.actual selector witness)
      SemanticRightRootResult5323.rawTerms
      SemanticRightRootResult5323.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult827.resultEvent
      SemanticRightRootResult827.owner
      (SemanticRightRootResult827.actual selector witness)
      SemanticRightRootResult827.rawTerms
      SemanticRightRootResult827.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_add_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5323.actual selector witness)
    (SemanticRightRootResult827.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5323.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult827.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5323.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult827.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5327

namespace SemanticRightRootResult5464

def leftRaw : List Term := SemanticRightRootResult5327.rawTerms
def rightRaw : List Term := SemanticRightRootResult32.rawTerms
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  SemanticRightRootResult5327.actual selector witness *
    SemanticRightRootResult32.actual selector witness
theorem claimOfHistory (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841)
    (expressionAt : document.expressions.lookup 18907 =
      some Mxx.Certificate.OperationalNoise.TallSecurity0Generated.Cert.Expression073.ExpressionRow18907)
    (leftPredecessorAt : (history.lookup 5328).map AnnotatedEvent.event =
      some (.predecessor owner 0 ⟨18905⟩ 5327))
    (rightPredecessorAt : (history.lookup 5329).map AnnotatedEvent.event =
      some (.predecessor owner 1 ⟨6564⟩ 32))
    (ruleAt : (history.lookup 5330).map AnnotatedEvent.event =
      some (.boundTransfer owner (.product (.predecessor 0 5328 .coefficient) (.predecessor 1 5329 .coefficient) ⟨false, false, none, none, none⟩)))
    (leftClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult5327.resultEvent
      SemanticRightRootResult5327.owner
      (SemanticRightRootResult5327.actual selector witness)
      SemanticRightRootResult5327.rawTerms
      SemanticRightRootResult5327.summary)
    (rightClaim : ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env
      SemanticRightRootResult32.resultEvent
      SemanticRightRootResult32.owner
      (SemanticRightRootResult32.actual selector witness)
      SemanticRightRootResult32.rawTerms
      SemanticRightRootResult32.summary)
    (outputAt : (history.lookup resultEvent).map AnnotatedEvent.event =
      some (.resultExact owner rawTerms summary)) :
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  ...
  exact exactValueClaim_product_of_mod_zero 100418593683253592432016548326729029359133068138294319235841 witness.env
    (SemanticRightRootResult5327.actual selector witness)
    (SemanticRightRootResult32.actual selector witness) left right output
    (by simpa [left, leftRaw, SemanticRightRootResult5327.summary] using leftClaim.claim)
    (by simpa [right, rightRaw, SemanticRightRootResult32.summary] using rightClaim.claim)
    (resultSound witness.env) (by decide)
...
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    ExactClaimAt history 100418593683253592432016548326729029359133068138294319235841 witness.env resultEvent owner
      (actual selector witness) rawTerms summary := by
  apply claimOfHistory selector witness (by rfl) (by rfl) (by rfl) (by rfl)
  · exact SemanticRightRootResult5327.claimSound
      selector selectorLower selectorUpper witness
  · exact SemanticRightRootResult32.claimSound
      selector selectorLower selectorUpper witness
  · rfl

end SemanticRightRootResult5464

namespace SemanticRightRootResult5476

def owner : Owner := ⟨.program ⟨214⟩, ⟨6646⟩⟩
def rawTerms : List Term := [{ coefficient := (1), monomial := { centralFactors := [], orderedFactors := [⟨.program ⟨214⟩, ⟨6645⟩⟩] } }]
def summary : Bound := .exactZero
...
theorem terminalAt (selector : Nat) (selectorLower : 0 ≤ selector)
  ...
  refine ⟨.scale (.predecessor 0 5473 .coefficient) (.value (.predecessor 1 5474 .coefficient)), 0, .scale (.predecessor 0 5473 .coefficient) (.value (.predecessor 1 5474 .coefficient)), ?_, ?_⟩
  · rfl
  · rfl
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    (selectorUpper : selector < 32)
...
end SemanticRightRootResult5476

namespace SemanticRightRootResult5487

def owner : Owner := ⟨.program ⟨214⟩, ⟨7820⟩⟩
def rawTerms : List Term := [{ coefficient := (1), monomial := { centralFactors := [], orderedFactors := [⟨.program ⟨214⟩, ⟨7819⟩⟩] } }]
def summary : Bound := .exactZero
...
theorem terminalAt (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    TerminalExactAt document history (some selector) producerEvent resultEvent owner rawTerms := by
  refine ⟨by decide, rightRootOwnerAtSelector214 selector selectorLower selectorUpper _, ?_⟩
  refine ⟨.scale (.predecessor 0 5484 .coefficient) (.value (.predecessor 1 5485 .coefficient)), 0, .scale (.predecessor 0 5484 .coefficient) (.value (.predecessor 1 5485 .coefficient)), ?_, ?_⟩
  · rfl
  · rfl
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    (selectorUpper : selector < 32)
...
end SemanticRightRootResult5487

namespace SemanticRightRootResult5499

def owner : Owner := ⟨.program ⟨214⟩, ⟨6652⟩⟩
def rawTerms : List Term := [{ coefficient := (1), monomial := { centralFactors := [], orderedFactors := [⟨.program ⟨214⟩, ⟨6651⟩⟩] } }]
def summary : Bound := .exactZero
def producerEvent : Nat := 5498
def resultEvent : Nat := 5499
def actual (selector : Nat)
    (witness : Witness document history (some selector) 100418593683253592432016548326729029359133068138294319235841) : Int :=
  witness.honestTerminalActual resultEvent
theorem terminalAt (selector : Nat) (selectorLower : 0 ≤ selector)
    ...
    TerminalExactAt document history (some selector) producerEvent resultEvent owner rawTerms := by
  refine ⟨by decide, rightRootOwnerAtSelector214 selector selectorLower selectorUpper _, ?_⟩
  refine ⟨.scale (.predecessor 0 5496 .coefficient) (.value (.predecessor 1 5497 .coefficient)), 0, .scale (.predecessor 0 5496 .coefficient) (.value (.predecessor 1 5497 .coefficient)), ?_, ?_⟩
  · rfl
  · rfl
theorem claimSound (selector : Nat) (selectorLower : 0 ≤ selector)
    (selectorUpper : selector < 32)
...
end SemanticRightRootResult5499
