...
use workspace_deps::{
    ...
    circuit::{NoCircuitEvaluator, PolyCircuit, gate::GateId},
    element::PolyElem,
    gadgets::{
...
async fn test_gpu_aky24_io_error_search_and_bench_estimate() {
    let log_filter = tracing_subscriber::filter::Targets::new()
        ...
        .with_target("mxx_io::aky24_io", tracing_subscriber::filter::LevelFilter::INFO)
        .with_target("mxx_gadgets::simulator::io", tracing_subscriber::filter::LevelFilter::INFO)
        .with_target(
            "mxx_gadgets::bench_estimator::native_gpu",
            tracing_subscriber::filter::LevelFilter::INFO,
        )
        .with_target(
            "mxx_io::aky24_io::bench_estimator",
            tracing_subscriber::filter::LevelFilter::INFO,
        )
        .with_target("mxx_gadgets::bench_estimator", tracing_subscriber::filter::LevelFilter::INFO)
        .with_target("mxx_gadgets::noise_refresh", tracing_subscriber::filter::LevelFilter::INFO)
        .with_target("mxx_gadgets::storage::write", tracing_subscriber::filter::LevelFilter::INFO)
