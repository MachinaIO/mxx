...
pub struct NoiseRefreshBenchEstimateParts {
    pub material: CircuitBenchSummary,
    pub per_refresh: CircuitBenchSummary,
    ...
    A: DecomposeArithmeticGadget<M::P> + ModularArithmeticPlanner<M::P>,
{
    ...
    pub fn estimate_preprocess_bench_parts<PKBE>(
        &self,
        public_key_estimator: &PKBE,
    ...
    pub fn estimate_online_eval_bench_parts<EncBE>(
        &self,
        encoding_estimator: &EncBE,
    ) -> NoiseRefreshBenchEstimateParts
    where
