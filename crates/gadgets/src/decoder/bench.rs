...
pub struct BitDecomposedRefreshMaterialCounts {
    pub error_prg_output_count: usize,
    pub mask_prg_output_count: usize,
    pub error_decrypt_contribution_count: usize,
    pub mask_decrypt_contribution_count: usize,
    pub mask_polynomial_count: usize,
    pub merge_add_count: usize,
}

impl BitDecomposedRefreshMaterialCounts {
    pub fn total_prg_output_count(&self) -> usize {
        self.error_prg_output_count
            .checked_add(self.mask_prg_output_count)
            .expect("bit-decomposed refresh PRG output count overflow")
    }

    pub fn total_decrypt_contribution_count(&self) -> usize {
...
pub fn bit_decomposed_refresh_material_counts(
    ring_dim: usize,
...
pub fn bit_decomposed_refresh_material_summary(
...
/// estimation.
pub fn goldreich_cbd_error_prg_summary(
...
pub fn bit_decomposed_polynomial_mask_decrypt_contribution_count(
    ring_dim: usize,
    mask_bits: usize,
    output_count: usize,
) -> BigUint {
...
pub fn scale_bit_decomposed_polynomial_mask_decrypt_contributions(
...
pub fn bit_decomposed_mask_reduce_add_count(mask_bits: usize) -> usize {
    mask_bits.saturating_sub(1)
}

/// Pairwise-addition tree depth needed to reduce `input_count` values to one.
pub fn pairwise_reduction_depth(input_count: usize) -> usize {
    if input_count <= 1 {
        return 0;
    }
...
pub fn bit_decomposed_polynomial_mask_reduction_summary(
    add_unit: CircuitBenchEstimate,
