...
//         ArithmeticCircuit::<DCRTPoly>::setup(&params, limb_bit_size, n, inputs.len(), true,
// true);     let add_idx = mixed_circuit.add(ArithGateId::new(0), ArithGateId::new(1)); // a + b
...
//     log_mem(format!("num gates {:?} total",
// mixed_circuit.poly_circuit.count_gates_by_type_vec()));
...
//     // (crt_depth*crt_bit)
//     let params = DCRTPolyParams::new(4, 1, 30, 13);
