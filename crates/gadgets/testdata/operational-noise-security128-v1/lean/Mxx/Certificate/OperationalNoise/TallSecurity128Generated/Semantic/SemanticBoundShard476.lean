...
namespace LeftBound75795
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75795
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6807⟩⟩, ⟨.program ⟨257⟩, ⟨45757⟩⟩], []⟩ [⟨.result 553 .coefficient, true, some 1⟩, ⟨.result 3587 .coefficient, true, some 1⟩]
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨45757⟩⟩) (rawTerms := some (Proof.Events014.exact3587RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := (LeftAuthority552.actual selector witness) * ([LeftAuthority3586.actual selector witness].prod)
...
namespace LeftBound75796
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75796
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75794, .transfer 75795]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75794)
      LeftBound75794.bound (LeftBound75794.actual selector witness) := by
  exact .transfer (LeftBound75794.derived selector witness)

theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75795)
      LeftBound75795.bound (LeftBound75795.actual selector witness) := by
  exact .transfer (LeftBound75795.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75794.bound, LeftBound75795.bound]
def bound : CoeffClass := .finite ⟨4683713856341753228595600, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75794.bound, LeftBound75795.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75794.actual selector witness, LeftBound75795.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
...
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6817⟩⟩, ⟨.program ⟨257⟩, ⟨43080⟩⟩], []⟩ [⟨.result 563 .coefficient, true, some 1⟩, ⟨.result 3595 .coefficient, true, some 1⟩]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨43080⟩⟩) (rawTerms := some (Proof.Events014.exact3595RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75796, .transfer 75797]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75796)
      LeftBound75796.bound (LeftBound75796.actual selector witness) := by
  exact .transfer (LeftBound75796.derived selector witness)

theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75797)
      LeftBound75797.bound (LeftBound75797.actual selector witness) := by
  exact .transfer (LeftBound75797.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75796.bound, LeftBound75797.bound]
def bound : CoeffClass := .finite ⟨4913864642405495209392960, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75796.bound, LeftBound75797.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75796.actual selector witness, LeftBound75797.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
...
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6828⟩⟩, ⟨.program ⟨257⟩, ⟨40400⟩⟩], []⟩ [⟨.result 573 .coefficient, true, some 1⟩, ⟨.result 3603 .coefficient, true, some 1⟩]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨40400⟩⟩) (rawTerms := some (Proof.Events014.exact3603RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
namespace LeftBound75800
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75800
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75798, .transfer 75799]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75799)
      LeftBound75799.bound (LeftBound75799.actual selector witness) := by
  exact .transfer (LeftBound75799.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75798.bound, LeftBound75799.bound]
def bound : CoeffClass := .finite ⟨5143450410172845024934680, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75798.bound, LeftBound75799.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75798.actual selector witness, LeftBound75799.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
...
namespace LeftBound75801
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75801
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6838⟩⟩, ⟨.program ⟨257⟩, ⟨37717⟩⟩], []⟩ [⟨.result 583 .coefficient, true, some 1⟩, ⟨.result 3611 .coefficient, true, some 1⟩]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨37717⟩⟩) (rawTerms := some (Proof.Events014.exact3611RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
namespace LeftBound75802
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75802
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75800, .transfer 75801]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75800)
      LeftBound75800.bound (LeftBound75800.actual selector witness) := by
  exact .transfer (LeftBound75800.derived selector witness)

theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75801)
      LeftBound75801.bound (LeftBound75801.actual selector witness) := by
  exact .transfer (LeftBound75801.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75800.bound, LeftBound75801.bound]
def bound : CoeffClass := .finite ⟨5372571899340058642669440, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75800.bound, LeftBound75801.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75800.actual selector witness, LeftBound75801.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
...
namespace LeftBound75803
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75803
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6842⟩⟩, ⟨.program ⟨257⟩, ⟨35037⟩⟩], []⟩ [⟨.result 593 .coefficient, true, some 1⟩, ⟨.result 3619 .coefficient, true, some 1⟩]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨35037⟩⟩) (rawTerms := some (Proof.Events014.exact3619RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
namespace LeftBound75804
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75804
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75802, .transfer 75803]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75802)
      LeftBound75802.bound (LeftBound75802.actual selector witness) := by
  exact .transfer (LeftBound75802.derived selector witness)

theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75803)
      LeftBound75803.bound (LeftBound75803.actual selector witness) := by
  exact .transfer (LeftBound75803.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75802.bound, LeftBound75803.bound]
def bound : CoeffClass := .finite ⟨5601427277602316147027040, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75802.bound, LeftBound75803.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75802.actual selector witness, LeftBound75803.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
...
namespace LeftBound75805
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75805
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6857⟩⟩, ⟨.program ⟨257⟩, ⟨29380⟩⟩], []⟩ [⟨.result 603 .coefficient, true, some 1⟩, ⟨.result 3627 .coefficient, true, some 1⟩]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨29380⟩⟩) (rawTerms := some (Proof.Events014.exact3627RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
namespace LeftBound75806
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75806
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75804, .transfer 75805]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75804)
      LeftBound75804.bound (LeftBound75804.actual selector witness) := by
  exact .transfer (LeftBound75804.derived selector witness)

theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75805)
      LeftBound75805.bound (LeftBound75805.actual selector witness) := by
  exact .transfer (LeftBound75805.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75804.bound, LeftBound75805.bound]
def bound : CoeffClass := .finite ⟨5829664127815216198670160, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75804.bound, LeftBound75805.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75804.actual selector witness, LeftBound75805.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
...
namespace LeftBound75807
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75807
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6860⟩⟩, ⟨.program ⟨257⟩, ⟨26700⟩⟩], []⟩ [⟨.result 613 .coefficient, true, some 1⟩, ⟨.result 3635 .coefficient, true, some 1⟩]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨26700⟩⟩) (rawTerms := some (Proof.Events014.exact3635RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
namespace LeftBound75808
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75808
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75806, .transfer 75807]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75806)
      LeftBound75806.bound (LeftBound75806.actual selector witness) := by
  exact .transfer (LeftBound75806.derived selector witness)

theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75807)
      LeftBound75807.bound (LeftBound75807.actual selector witness) := by
  exact .transfer (LeftBound75807.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75806.bound, LeftBound75807.bound]
def bound : CoeffClass := .finite ⟨6056673898188261948960360, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75806.bound, LeftBound75807.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75806.actual selector witness, LeftBound75807.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
...
namespace LeftBound75809
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75809
def frameStart : Nat := 0
def rule : BoundRule := .monomialProduct ⟨[⟨.program ⟨257⟩, ⟨6870⟩⟩, ⟨.program ⟨257⟩, ⟨67008⟩⟩], []⟩ [⟨.result 623 .coefficient, true, some 1⟩, ⟨.result 3643 .coefficient, true, some 1⟩]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
...
theorem input1 (selector : Nat)
  ...
  refine .result (resultOwner := ⟨.program ⟨257⟩, ⟨67008⟩⟩) (rawTerms := some (Proof.Events014.exact3643RawTerms)) (by decide) ?_
  exact .resultExactCoefficient (by rfl)
...
namespace LeftBound75810
def owner : Owner := ⟨.program ⟨257⟩, ⟨67592⟩⟩
def transferEvent : Nat := 75810
def frameStart : Nat := 0
def rule : BoundRule := .sum [.transfer 75808, .transfer 75809]
theorem input0 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75808)
      LeftBound75808.bound (LeftBound75808.actual selector witness) := by
  exact .transfer (LeftBound75808.derived selector witness)

theorem input1 (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundInputAt history owner (.transfer 75809)
      LeftBound75809.bound (LeftBound75809.actual selector witness) := by
  exact .transfer (LeftBound75809.derived selector witness)

def rawBound : CoeffClass := addKnownList [LeftBound75808.bound, LeftBound75809.bound]
def bound : CoeffClass := .finite ⟨6283161807020220237755640, by decide⟩
theorem rawBound_eq_bound : rawBound = bound := by
  dsimp [rawBound, bound, LeftBound75808.bound, LeftBound75809.bound, addKnownList, addKnown, productWithFactor,
    scaleMagnitude, scaleValue, productNonempty] <;> decide
def actual (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) : Nat := [LeftBound75808.actual selector witness, LeftBound75809.actual selector witness].sum
theorem derived (selector : Nat)
    (witness : Witness document history (some selector) 2596118388884299782786442882919966202757356512598865539416966488295494748974456019701577684907109706420296806278632487222012309918168506832951461416943272286629018402817) :
    BoundDerivedAt history transferEvent frameStart owner rule bound
      (actual selector witness) := by
