...
use crate::{
    bench_estimator::{
        CircuitBenchEstimate, CircuitBenchSummary, NativePolyMatrixBenchEstimator,
        benchmark_gate_operation, scale_independent_estimate,
    },
    matrix::PolyMatrix,
    poly::Poly,
...
#[derive(Debug, Clone)]
pub struct DiamondInputInjectionBenchShape {
    pub state_row_size: usize,
    pub state_col_size: usize,
    pub checkpoint_count: usize,
    pub final_checkpoint_count: usize,
    pub transition_matrix_count: usize,
    pub transition_preimage_chunk_count: usize,
    pub secret_mask_materialize_count: usize,
    pub device_count: usize,
    pub online_level_state_counts: Vec<usize>,
    pub transition_chunk_col_lens: Vec<usize>,
}

#[derive(Debug, Clone, PartialEq)]
pub struct DiamondInputInjectionBenchEstimate {
    pub preprocess: CircuitBenchSummary,
    pub online: CircuitBenchSummary,
    pub checkpoint_sampling: CircuitBenchSummary,
    pub preprocess_artifact_materialization: CircuitBenchSummary,
    pub initial_state: CircuitBenchSummary,
    pub transition_target_building: CircuitBenchSummary,
    pub transition_preimages: CircuitBenchSummary,
    pub online_artifact_materialization: CircuitBenchSummary,
    pub online_state_transitions: CircuitBenchSummary,
}

#[derive(Debug, Clone)]
pub struct DiamondInputInjectionBenchUnitEstimates {
    pub trapdoor_checkpoint: CircuitBenchEstimate,
    pub transition_preimage: CircuitBenchEstimate,
    pub preimage_one_column: CircuitBenchEstimate,
    pub checkpoint_artifact_persist: CircuitBenchEstimate,
    pub stage_public_checkpoint_decode: CircuitBenchEstimate,
    pub stage_trapdoor_checkpoint_decode: CircuitBenchEstimate,
    pub final_public_checkpoint_decode: CircuitBenchEstimate,
    pub final_trapdoor_checkpoint_decode: CircuitBenchEstimate,
    pub secret_mask_materialize: CircuitBenchEstimate,
    pub transition_secret_mask_decode: CircuitBenchEstimate,
    pub initial_error_sample: CircuitBenchEstimate,
    pub initial_state_persist: CircuitBenchEstimate,
    pub transition_error_sample: CircuitBenchEstimate,
    pub transition_preimage_persist: CircuitBenchEstimate,
    pub online_initial_state_read_decode: CircuitBenchEstimate,
    pub online_lhs_state_serialize: CircuitBenchEstimate,
    pub online_lhs_state_decode: CircuitBenchEstimate,
    pub online_rhs_chunk_read_decode: CircuitBenchEstimate,
    pub online_output_chunk_serialize: CircuitBenchEstimate,
    pub online_output_recompose: CircuitBenchEstimate,
}
...
impl DiamondInputInjectionBenchShape {
    ...
    where
        NBE: NativePolyMatrixBenchEstimator,
    {
