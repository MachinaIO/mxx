...
use crate::{
    ...
    circuit::{Evaluable, NoCircuitEvaluator, PolyCircuit},
    decoder::{
...
pub use bench_estimator::{
    DiamondIOBenchEstimate, DiamondIOBenchEstimator, NativePolyMatrixBenchEstimator,
};
pub use simulation::{
...
mod tests {
    ...
    async fn test_gpu_diamond_io_debug_decryption_eval_returns_seed_bits() {
        let log_filter = tracing_subscriber::filter::Targets::new()
            ...
            .with_target("mxx_io::diamond_io", tracing::Level::INFO)
            .with_target("mxx_gadgets::input_injector::gpu", tracing::Level::INFO)
            .with_target("mxx_gadgets::noise_refresh::naive_vec", tracing::Level::INFO)
            .with_target("mxx_gadgets::storage::write", tracing::Level::INFO);
